		...
		if (mappingData.isMainImage) {
			...
			if (this.configImageware["enableImageware"] != "") {
				...
				if (mappingData.imgPopup != "") {
						imgTag = this.configDefault["loadingImage"]+"<a id=\"tehee\"  href=\""+mappingData.imgPopup+"\"  class=\"jqzoomevo mainImage\" onclick=\"javascript: var instance = " + this.productManagerGlobalVariableName + ".getProductObjectByUniqueId(" + this.configObjArea["objProductUniqueId"] + "); instance.doPopup('"+mappingData.attValue+"',this.href, "+mappingData.currentImage+"); return false;\" title=\""+mappingData.imgTitle+"\"><img id=\"venga\" class=\"mainImage\" src=\""+mappingData.imgSource+"\" style=\"display:none\" onload=\"javascript: var instance = " + this.productManagerGlobalVariableName + ".getProductObjectByUniqueId(" + this.configObjArea["objProductUniqueId"] + "); instance.showMainImage.setImg(this); instance.showMainImage.doIt(instance.showMainImage);\"></a>";
				} else {
					if (this.allImages[mappingData.attValue].clicked[mappingData.currentImage] == true) {
