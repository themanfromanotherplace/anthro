...
function AttributeSwatchClass(){
	...
	this.setProductDetailInstance = function(productDetailInstance){
	...
	this.productManagerGlobalVariableName = "";
	...
	this.getProductDetailInstance = function(){
		
		return this.productDetailInstance;
		
	};
	
	this.setProductInstance = function(productInstance){
		
		this.productInstance = productInstance;
	};
	
	this.getProductInstance = function(){
	...
	this.defaultprice = "";
	this.defaultwasprice = "";
	
	this.initListAttributes = function(attrColumn, attrName) {
	...
	this.addToListAttributes = function(attrColumn, attrValue) {
	...
	this.isExistInListAttributes = function(attrColumn, attrValue) {
		var found = false;
		if (this.ListAttributes[attrColumn]) {
	...
	this.createListAttributes=function(attrColumn,attrName,ddObj){
		this.ListAttributes[attrColumn] = new Array();
	...
	this.addFilter = function(attrColumn,attrValue) {
		var filterString="";
	...
	this.checkAvailAttributes = function(attrColumn,attrValue) {
		this.existingAttributes = new Array();
		this.availAttributes = new Array();
	...
	this.checkAvailOneAttributes = function(attrColumn, attrName) {
		this.existingAttributes = new Array();
		this.availAttributes = new Array();
		a=0;	
	...
	this.updateListAttributes = function(attrColumn,attrColumnSelect) {
	...
	this.highlightSelection = function(attrColumn,id){
		for(i=0; i < this.ListAttributes[attrColumn].length; i++){
	...
	this.changePrice = function(id, wasid){
		var price = "";
		var wasprice = "";
	...
	this.actionSet = function(attrColumn,attrValue){
	...
	this.mediapath="";
	this.addtobasketbt="bt_addtobasket.gif";
	this.backorderbt="bt_backorder.gif";
	this.today="";
	
	this.etaDate=function(){
	...
	this.showTooltipMessage = function (id){
